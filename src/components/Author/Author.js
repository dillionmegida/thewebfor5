...
export default (props) => {
  ...
  const filteredAuthor = AllAuthors.filter(
    ...
    <Layout
      ...
      SecondSection={
        <StaticQuery
          ...
          `}
          render={(data) => {
            const authorArticles = data.allPosts.edges.filter(
              ({ node }) => node.frontmatter.authorID === author.authorID
            )
            ...
            return (
              <section className={Styles.Author}>
                ...
                <div className={Styles.Details}>
                  ...
                  <p>
                    <b>{noOfArticles}</b> article{noOfArticles === 1 ? "" : "s"}{" "}
                    written.
                  </p>
                  <p>
                    <b>Bio:</b> <br />
