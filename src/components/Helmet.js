...
const AppHelmet = (props) => (
  <Helmet>
    ...
    <link
      rel="canonical"
      href={`https://thewebfor5.com${props.PageLink}`}
    />{" "}
    {/* edit */}
    <meta name="description" content={props.PageDescription} /> {/* edit */}
    <meta
      name="keywords"
      content={`thewebfor5, web, explain like I'm five, ELI5, beginners, ${props.PageKeywords}`}
    />{" "}
    {/* edit */}
    {/* Choose author name from blogs. If authorName prop isn't declared, use DIllion Megida */}
    <meta
      name="author"
      content={props.AuthorName ? props.AuthorName : "Dillion Megida"}
    />
    ...
    <meta
      property="og:url"
      content={`https://thewebfor5.com${props.PageLink}`}
    />
    ...
    <meta
      name="twitter:card"
      content={props.SummaryCard ? "summary" : "summary_large_image"}
    />
    ...
    <meta
      name="twitter:image"
      content={
        props.ImageCard ? props.ImageCard : `https://thewebfor5.com${MainImg}`
      }
    />{" "}
    {/* edit */}
    <meta
      name="twitter:creator"
      content={props.AuthorTwitter ? props.AuthorTwitter : "iamdillion"}
    />
